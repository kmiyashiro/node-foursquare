...
module.exports = function(config) {
  ...
  function getVenue(venueId, accessToken, callback) {
    ...
    core.callApi("/venues/" + venueId, accessToken, null, callback);
  }
  ...
  function getVenueAspect(venueId, aspect, params, accessToken, callback) {
    ...
    core.callApi("/venues/" + venueId + '/' + aspect, accessToken, params || {}, callback);
  }
  ...
  function getHereNow(venueId, params, accessToken, callback) {
    ...
    core.callApi("/venues/" + venueId + '/' + "herenow", accessToken, params || {}, callback);
  }
