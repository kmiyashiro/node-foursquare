/**
 * Construct the Foursquare.Specials module.
 * @param {Object} config A valid configuration.
 */
module.exports = function(config){
  var core = require("./core")(config),
    logger = require('log4js')(config.log4js).getLogger("node-foursquare.Specials");
  ...
  function search(lat, lng, params, accessToken, callback) {
    ...
    core.callApi("/specials/search", accessToken, "specials", params, callback);
  }
